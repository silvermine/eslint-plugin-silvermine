   ...
   create: function(context) {
      ...
      function checkMemberExpression(node) {
         var numberOfLines = node.property.loc.start.line - node.object.loc.end.line + 1,
             objectComments = helper.sourceCode.getComments(node.object);
         ...
         // Note: trailing comments of the `node.object` are leading comments for this
         // property
         if (objectComments.trailing) {
            _.each(objectComments.trailing, function(comment) {
