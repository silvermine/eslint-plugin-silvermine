/**
* Forked from: https://github.com/eslint/eslint/blob/v5.13.0/lib/util/ast-utils.js
*/

/* eslint-disable @silvermine/silvermine/block-scope-case, @silvermine/silvermine/no-multiline-conditionals, max-len, complexity */
...
module.exports = {
   ...
   getParenthesisedText(sourceCode, node) {
      let leftToken = sourceCode.getFirstToken(node),
          rightToken = sourceCode.getLastToken(node);
